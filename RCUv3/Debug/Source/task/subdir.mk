...
C_SRCS += \
../Source/task/ethernet.c \
../Source/task/handlerIOTask.c \
../Source/task/main.c 

OBJS += \
./Source/task/ethernet.o \
./Source/task/handlerIOTask.o \
./Source/task/main.o 

C_DEPS += \
./Source/task/ethernet.d \
...
clean-Source-2f-task:
	-$(RM) ./Source/task/ethernet.cyclo ./Source/task/ethernet.d ./Source/task/ethernet.o ./Source/task/ethernet.su ./Source/task/handlerIOTask.cyclo ./Source/task/handlerIOTask.d ./Source/task/handlerIOTask.o ./Source/task/handlerIOTask.su ./Source/task/main.cyclo ./Source/task/main.d ./Source/task/main.o ./Source/task/main.su
